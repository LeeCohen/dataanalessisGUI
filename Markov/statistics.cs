...
namespace makrovchain1
{
	...
	public class statistics
	{
		...
		public double Z(double member)
		{
			try
			{
				if (exist(member)) return (member-mean())/STD();
		...
		public double r(statistics design)
		{
			try
			{
				return this.cov(design)/(this.STD()*design.STD());
			}
			catch(Exception)
			{
				return double.NaN;
		...
		public static double r(statistics design1,statistics design2)
		{
			try
			{
				return cov(design1,design2)/(design1.STD()*design2.STD());
			}
			catch(Exception)
			{
				return double.NaN;
		...
		public double a(statistics design)
		{
			try
			{
				return this.cov(design)/(Math.Pow(design.STD(),2));
			}
			catch(Exception)
			{
				return double.NaN;
		...
		public static double a(statistics design1,statistics design2)
		{
			try
			{
				return cov(design1,design2)/(Math.Pow(design2.STD(),2));
			}
			catch (Exception)
			{
				return double.NaN;
